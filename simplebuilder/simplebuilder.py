...
def main():
    ...
    parser = argparse.ArgumentParser(description="Simple build system with stdin job flow")
    parser.add_argument("--workspace", default="./workspace", help="Local workspace (default: %(default)s)")
    parser.add_argument("--repository", default="./workspace/reposutory", help="Local repository (default: %(default)s)")
